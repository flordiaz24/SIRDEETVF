...
var rutaGlobal='//'+location.host+'/sirdeetv/faces/javax.faces.resource/leaflet/images/';
!(function(t, i) {
  ...
  function wi(t, i) {
    (t._leaflet_pos = i),
      yt ? xi(t, i) : ((t.style.left = i.x + 1 + "px"), (t.style.top = i.y + 1 + "px"));
  }
  function Pi(t) {
  ...
  var Be = ke.extend({
      options: {
          /*
        iconUrl: url("#{resource['leaflet/images/marker-icon.png']}"),
        iconRetinaUrl: url("#{resource['leaflet/images/marker-icon-2x.png']}"),
        shadowUrl: url("#{resource['leaflet/images/marker-shadow.png']}"),
           */
  ...
  var rn = Se.extend({
    ...
    _initTile: function(t) {
      ...
      (t.style.width = i.x + 1 + "px"),
        (t.style.height = i.y + 1 + "px"),
        (t.onselectstart = l),
        (t.onmousemove = l),
