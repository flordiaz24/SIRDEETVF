 ...
 */ !(function (t) {
  ...
  function (t, e) {
    ...
    (L.Control.BrowserPrint.Mode = function (t, e, r, n, i) {
      ...
      (this.PageSeries =
            ['A', 'B', 'C', 'D'].indexOf(this.PageSize[0]) != -1
              ? this.PageSize[0]
              : ''),
    ...
    (L.Control.BrowserPrint.Mode.prototype.getSize = function () {
      ...
      var e = parseInt(this.getPageMargin())

      var r = function (t) {
        return e ? t - 2 * e : t
      }
      return (
        (t.Width = Math.floor(r(t.Width)) + 'mm'),
  ...
  function (t, e) {
    L.Control.BrowserPrint.Utils = {
      ...
      initialize: function () {
        ...
        this.registerLayer(L.TileLayer.WMS, 'L.TileLayer.WMS', function (
          t,
          e
        ) {
        ...
        this.registerLayer(L.MultiPolyline, 'L.MultiPolyline', function (
          t,
          e
        ) {
    ...
    ;(L.Control.BrowserPrint = L.Control.extend({
      ...
      onAdd: function (t) {
        this.options.customPrintStyle.pane &&
          ...
          (t.createPane(this.options.customPrintStyle.pane).style.zIndex = 9999)
      ...
      _addPrintClassToContainer: function (t, e) {
        ...
        r.className.indexOf(e) === -1 && (r.className += ' ' + e)
      },
      ...
      _setupPrintPagesWidth: function (t, e, r) {
        t.style.width = r === 'Landscape' ? e.Height : e.Width
      },
      _setupPrintMapHeight: function (t, e, r) {
        t.style.height = r === 'Landscape' ? e.Width : e.Height
      },
      cancel: function (t) {
      ...
      _print: function (t, e) {
        ...
        ) { delete this.cancelNextPrinting } else {
      ...
      _appendControlStyles: function (t) {
        ...
        (e.innerHTML +=
            ' .leaflet-control-browser-print a.leaflet-browser-print { background-position-x: 7px; }'),
        (e.innerHTML +=
            ' .browser-print-holder { margin: 0px; padding: 0px; list-style: none; white-space: nowrap; } .browser-print-holder-left li:last-child { border-top-right-radius: 2px; border-bottom-right-radius: 2px; } .browser-print-holder-right li:first-child { border-top-left-radius: 2px; border-bottom-left-radius: 2px; }'),
        (e.innerHTML +=
            " .browser-print-mode { display: none; background-color: #919187; color: #FFF; font: 11px/19px 'Helvetica Neue', Arial, Helvetica, sans-serif; text-decoration: none; padding: 4px 10px; text-align: center; } .browser-print-mode { padding: 6px 10px; } .browser-print-mode:hover { background-color: #757570; cursor: pointer; }"),
        (e.innerHTML +=
