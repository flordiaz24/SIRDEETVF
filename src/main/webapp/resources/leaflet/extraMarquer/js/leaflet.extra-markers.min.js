...
!(function(e, r) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], r)
    : r(((e.leaflet = e.leaflet || {}), (e.leaflet["extra-markers"] = {})));
})(this, function(e) {
  "use strict";
  var r = (L.ExtraMarkers = {});
  (r.version = L.ExtraMarkers.version = "1.0.8"),
    (r.Icon = L.ExtraMarkers.Icon = L.Icon.extend({
      options: {
        iconSize: [35, 45],
        iconAnchor: [17, 42],
        popupAnchor: [1, -32],
      ...
      createIcon: function() {
        var e = document.createElement("div"),
          r = this.options;
        return (
          r.icon && (e.innerHTML = this._createInner()),
          r.innerHTML && (e.innerHTML = r.innerHTML),
          r.bgPos &&
            (e.style.backgroundPosition =
              -r.bgPos.x + "px " + -r.bgPos.y + "px"),
          r.svg
            ? this._setIconStyles(e, "svg")
            : this._setIconStyles(e, r.shape + "-" + r.markerColor),
          e
        );
      },
      _createInner: function() {
        var e = "",
          ...
          t = this.options;
        if (
          (t.iconColor && (e = "style='color: " + t.iconColor + "' "),
      ...
      _setIconStyles: function(e, r) {
        var t,
          s,
          o = this.options,
          n = L.point(o["shadow" === r ? "shadowSize" : "iconSize"]);
        "shadow" === r
          ? ((t = L.point(o.shadowAnchor || o.iconAnchor)), (s = "shadow"))
          : ((t = L.point(o.iconAnchor)), (s = "icon")),
    ...
    (r.icon = L.ExtraMarkers.icon = function(e) {
